#ifndef GICP_LOCALIZER_RTK_GATE_HPP
#define GICP_LOCALIZER_RTK_GATE_HPP
...
// RTK-quality, letting unknown-quality reference-odometry samples drive
// the INS heading prior and RTK bias calibration. This matches the adapter's
// stricter reference-odometry RTK-fixed gate (finite, nonnegative,
// thresholded).
...
#endif  // GICP_LOCALIZER_RTK_GATE_HPP
